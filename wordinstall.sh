...
echo 'root' | sudo -kS  pip3 install defaultcreds-cheat-sheet
...
#fuzzing-directory  
wget https://raw.githubusercontent.com/ayoubfathi/leaky-paths/main/leaky-paths.txt -P   ~/wordlist/fuzzing/
...
wget https://raw.githubusercontent.com/danielmiessler/SecLists/master/Discovery/DNS/namelist.txt -P  ~/wordlist/dns/
...
#payloads
git clone https://github.com/coffinsp/payloads  ~/wordlist/conffinxp-wordlist
